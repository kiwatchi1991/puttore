<div class="c-paging">
    ...
    <span class="c-pagination__count">{{ $paginator->firstItem() }} - {{ $paginator->lastItem() }} / {{ $paginator->total() }}</span>
    ...
    @else
    <li class="disabled" aria-disabled="true">
        <span class="c-pagination__next inactive"><i class="fas fa-angle-right c-pagination__next--angle"></i></span>
    </li>
    @endif
</ul>
@endif
