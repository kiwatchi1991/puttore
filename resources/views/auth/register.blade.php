            ...
            <div class="c-register__input-area">
                ...
                <div>
                    <input id="password" type="password"
                        class="c-register__input @error('account_id') is-invalid @enderror" name="password" required
            ...
            <div class="c-register__input-area">
                ...
                <div>
                    <input id="password-confirm" type="password"
                        class="c-register__input @error('account_id') is-invalid @enderror" name="password_confirmation"
