    ...
    <div class="c-searchBox__inner">
        <form method="POST" action="{{ route('products') }}" enctype="multipart/form-data" >
            ...
            <div class="c-searchBox__categories">
                ...
                <input id="c-{{ $categories->id }}" type="checkbox" class="c-searchBox__checkbox @error('lang') is-invalid @enderror"
            ...
            @foreach ($difficult as $difficults)
                <input id="d-{{ $difficults->id }}" type="checkbox" class="c-searchBox__checkbox @error('difficult') is-invalid @enderror"
